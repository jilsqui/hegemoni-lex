      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center p-6 md:p-16 lg:p-24 lg:border-r-2 border-black relative">
        ...
        <div className="max-w-md w-full mx-auto">
            ...
            <div className="mb-8 md:mb-12">
                ...
                <h1 className="text-3xl md:text-5xl font-serif font-medium mb-3 md:mb-4 text-black">Selamat Datang</h1>
                <p className="text-black font-normal leading-relaxed text-sm md:text-base">Masuk untuk mengelola konten atau mengakses fitur premium.</p>
            </div>
      ...
      <div className="hidden lg:flex w-1/2 bg-black text-white flex-col justify-between p-24 relative overflow-hidden">
        ...
        <div className="relative z-10">
            <h2 className="text-5xl font-serif font-light leading-tight mb-8">
              "Makin aku banyak membaca, makin aku banyak berpikir; makin aku banyak belajar, makin aku sadar bahwa aku <span className="italic border-b border-white pb-1">tak mengetahui apa pun</span>."
            </h2>
            <div className="flex items-center gap-4">
                <div className="h-[2px] w-12 bg-white"></div>
                <p className="text-xs font-bold uppercase tracking-[0.3em] text-gray-400">Voltaire</p>
            </div>
        </div>
